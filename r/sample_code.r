...
#Read the data:
TrainingData = read.csv("raw_data/TrainingData.csv")
SubmissionZeros = read.csv("raw_data/SubmissionZerosExceptNAs.csv")
...
write.csv(submission_hour_means_NAs, "sample_code/submission_hour_means.csv", row.names = FALSE)
...
write.csv(submission_hour_chunk_means_NAs, "sample_code/submission_hour_chunk_means.csv", row.names = FALSE)
